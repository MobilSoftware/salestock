...
import com.mascova.talarion.security.AjaxAuthenticationFailureHandler;
import com.mascova.talarion.security.AjaxAuthenticationSuccessHandler;
import com.mascova.talarion.security.AjaxLogoutSuccessHandler;
import com.mascova.talarion.security.AuthoritiesConstants;
import com.mascova.talarion.security.CustomAccessDeniedHandler;
import com.mascova.talarion.security.Http401UnauthorizedEntryPoint;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().and().addFilterAfter(new CsrfCookieGeneratorFilter(), CsrfFilter.class)
