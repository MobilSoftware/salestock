...
public class SalesHeadSpecification implements Specification<SalesHead> {

  private SearchCriteria criteria;

  public SalesHeadSpecification(SearchCriteria criteria) {
    super();
    this.criteria = criteria;
  }

  @Override
  public Predicate toPredicate(Root<SalesHead> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
