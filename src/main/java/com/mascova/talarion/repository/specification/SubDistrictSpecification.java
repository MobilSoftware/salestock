...
public class SubDistrictSpecification implements Specification<SubDistrict> {

  private SearchCriteria criteria;

  public SubDistrictSpecification(SearchCriteria criteria) {
    super();
    this.criteria = criteria;
  }

  @Override
  public Predicate toPredicate(Root<SubDistrict> root, CriteriaQuery<?> query,
