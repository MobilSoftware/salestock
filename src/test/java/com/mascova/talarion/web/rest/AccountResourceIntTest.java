...
import com.mascova.talarion.TalarionApp;
...
@SpringApplicationConfiguration(classes = TalarionApp.class)
@WebAppConfiguration
@IntegrationTest
public class AccountResourceIntTest {
  ...
  public void testRegisterDuplicateLogin() throws Exception {
    ...
    UserDTO dup = new UserDTO(u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
        "alicejr@example.com", true, u.getLangKey(), u.getAuthorities(), group, null);
  ...
  public void testRegisterDuplicateEmail() throws Exception {
    ...
    UserDTO dup = new UserDTO("johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
        u.getEmail(), true, u.getLangKey(), u.getAuthorities(), group, null);
  ...
  public void testRegisterAdminIsIgnored() throws Exception {
    ...
    UserDTO u = new UserDTO("badguy", // login
        ...
        true, // activated
        "en", // langKey
        new HashSet<>(Arrays.asList(AuthoritiesConstants.ADMIN)), group, null // <-- only admin
                                                                              // should be able to
    // do that
    );
